...
#            df = df.drop(i)
    ...
    df = df.drop(['Date','High','Low', '30 mavg', '30 std', '26 ema', '12 ema', 'MACD', 'Signal'], axis=1)
...
#df_btc.to_csv(r'C:\Users\techm\Documents\GitHub\CryptoFund\test\bitcoin.csv', index=False)
#df_eth.to_csv(r'C:\Users\techm\Documents\GitHub\CryptoFund\test\ethereum.csv', index=False)
#df_dash.to_csv(r'C:\Users\techm\Documents\GitHub\CryptoFund\test\dash.csv', index=False)
#df_ltc.to_csv(r'C:\Users\techm\Documents\GitHub\CryptoFund\test\litecoin.csv', index=False)
#df_xmr.to_csv(r'C:\Users\techm\Documents\GitHub\CryptoFund\test\monero.csv', index=False)
#df_xrp.to_csv(r'C:\Users\techm\Documents\GitHub\CryptoFund\test\ripple.csv', index=False)